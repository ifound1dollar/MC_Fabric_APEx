...
public class ModNetheriteShovelItem extends ShovelItem {
    public ModNetheriteShovelItem(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ModUtils.applyNetheriteOnHit(target, attacker);
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ModUtils.appendNetheriteEquipmentTooltip(tooltip, false);
    }
}
