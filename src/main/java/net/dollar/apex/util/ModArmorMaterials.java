...
public interface ModArmorMaterials {
    ArmorMaterial BRONZE = new ArmorMaterial(15, Util.make(
            ...
            ModTags.Items.COMMON_BRONZE_INGOTS, EquipmentAssetKeys.IRON);
    ArmorMaterial GILDED_BRONZE = new ArmorMaterial(23, Util.make(
            ...
            ItemTags.REPAIRS_GOLD_ARMOR, EquipmentAssetKeys.GOLD);
    ArmorMaterial COBALT_STEEL = new ArmorMaterial(37, Util.make(
            ...
            ModTags.Items.MOD_REPAIRS_COBALT_STEEL_EQUIPMENT, EquipmentAssetKeys.NETHERITE);
    ArmorMaterial INFUSED_GEMSTONE = new ArmorMaterial(37, Util.make(
            ...
            ModTags.Items.MOD_REPAIRS_INFUSED_GEMSTONE_EQUIPMENT, EquipmentAssetKeys.DIAMOND);
    ArmorMaterial TUNGSTEN_CARBIDE = new ArmorMaterial(41, Util.make(
            ...
            ModTags.Items.MOD_REPAIRS_TUNGSTEN_CARBIDE_EQUIPMENT, EquipmentAssetKeys.NETHERITE);
}