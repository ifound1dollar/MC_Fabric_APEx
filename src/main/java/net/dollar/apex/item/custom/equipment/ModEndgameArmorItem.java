...
public class ModEndgameArmorItem extends ArmorItem implements IFullSetEffectArmor {
    private final BiPredicate<StatusEffect, LivingEntity> canReceiveEffectMethod;
     ...
     * @param type ArmorItem.Type determining the type of armor piece
     * @param tier EndgameTier determining which effect to be prevented with a full set of armor
     * @param settings Item.Settings associated with the armor item
     */
    public ModEndgameArmorItem(ArmorMaterial material, Type type,
