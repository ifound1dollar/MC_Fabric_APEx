...
public class ModCobaltSteelSwordItem extends Item {
    public ModCobaltSteelSwordItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Settings settings) {
