...
public class ModInfusedGemstoneSwordItem extends Item implements IInfusedGemstoneItem {
    public ModInfusedGemstoneSwordItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Settings settings) {
