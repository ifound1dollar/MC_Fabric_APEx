...
public class ModEndgameAxeItem extends AxeItem {
     ...
     * @param material ToolMaterial for this AxeItem
     * @param attackDamage Attack damage of this axe
     * @param attackSpeed Attack speed of this axe
     * @param settings Item.Settings associated with this axe, should already have called .axe()
