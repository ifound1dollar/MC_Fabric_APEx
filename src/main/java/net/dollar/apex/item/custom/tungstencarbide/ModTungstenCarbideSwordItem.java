...
public class ModTungstenCarbideSwordItem extends Item {
    public ModTungstenCarbideSwordItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Settings settings) {
