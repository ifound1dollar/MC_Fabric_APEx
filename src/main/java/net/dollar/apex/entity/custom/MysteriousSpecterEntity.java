...
public class MysteriousSpecterEntity extends HostileEntity implements Angerable {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(9, new WanderAroundFarGoal(this, 0.6, 0.01f));

        this.targetSelector.add(2, new RevengeGoal(this));
        this.targetSelector.add(4, new UniversalAngerGoal<>(this, false));

        // Adds a custom goal which causes this mob to stare at the player indefinitely while in range.
